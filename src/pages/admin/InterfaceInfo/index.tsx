...
import {
  addUsingPost, deleteUsingPost, listInterfaceInfoByPageUsingGet,
  onLineUsingPost,
  unLineUsingPost,
  updateUsingPost
...
const TableList: React.FC = () => {
   ...
   * @param record
   */
  const handleUnLine = async (record: API.IdRequest) => {
    const hide = message.loading('下线中');
    if (!record) return true;
    try {
      await unLineUsingPost({
        id: record.id
      });
      hide();
